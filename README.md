...
* Text parsing reveals that pest control (mice,flies,rats) and sanitation constitute the most frequent categoriesfor critical flags across NYC kitchens
...
1. Download the raw data from NYC OPen Data 
2. Run `python analysis.py` to generate the terminal summary and the Seaborn visualization chart
